...
# Komandat per perdorim te aplikacionit
def usage():
...
# Funksioni qe percakton se a eshte website i mbrojtur me cloudflare
def cloudflare():
    cfmessage = False 
...
# Formimi i HTTP kerkeses nese cloudflare == False
def set_request():
    global request
...
# Formimi i HTTP kerkeses nese cloudflare == True
def set_request_cf():
    global request_cf
    global proxy_ip
    global proxy_port
